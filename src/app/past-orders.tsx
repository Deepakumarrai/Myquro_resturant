        ...
        >
          ...
          <View style={styles.analyticsSection}>
            ...
            <View style={styles.peakContainer}>
              ...
              <View style={styles.peakBox}>
                <Ionicons name="moon-outline" size={18} color="#F5A623" />
                ...
                return (
                  <View key={status} style={styles.statusRow}>
                    ...
                    <View style={styles.statusTrack}>
                      <View style={[styles.statusFill, { width: `${pct}%`, backgroundColor: status === 'Picked up' ? '#2ECC71' : status === 'Rejected' ? '#E74C3C' : '#F5A623' }]} />
                    </View>
            ...
            {paginatedOrders.length > 0 ? (
              <View style={styles.tableContainer}>
                {paginatedOrders.map((order) => (
                  ...
                  >
                    ...
                    <View style={styles.orderRightMeta}>
                      ...
                      <View style={[styles.statusBadge, { backgroundColor: order.status === 'Picked up' ? 'rgba(46,204,113,0.1)' : order.status === 'Rejected' ? 'rgba(231,76,60,0.1)' : 'rgba(245,166,35,0.1)' }]}>
                        <Text style={[styles.statusBadgeText, { color: order.status === 'Picked up' ? '#2ECC71' : order.status === 'Rejected' ? '#E74C3C' : '#F5A623' }]}>
                ...
                <View style={styles.paginationRow}>
                  ...
                  >
                    <Ionicons name="chevron-back" size={16} color={currentPage === 1 ? 'rgba(255,255,255,0.2)' : '#F5A623'} />
                  </TouchableOpacity>
                  ...
                  >
                    <Ionicons name="chevron-forward" size={16} color={currentPage === totalPages ? 'rgba(255,255,255,0.2)' : '#F5A623'} />
                  </TouchableOpacity>
                </View>
              </View>
            ) : (
              ...
              <View style={styles.modalScroll}>
                ...
                <View style={styles.receiptBox}>
                  <View style={styles.receiptSumRow}>
                    ...
                    <Text style={styles.receiptSumValue}>₹{selectedOrder.total}</Text>
                  </View>
                  <View style={styles.receiptSumRow}>
                    <Text style={styles.receiptSumLabel}>Discount</Text>
                    <Text style={styles.receiptSumValue}>-₹0</Text>
                  </View>
                  <View style={styles.receiptSumRow}>
                    <Text style={styles.receiptSumLabel}>Taxes (GST 5%)</Text>
                    <Text style={styles.receiptSumValue}>₹{Math.round(selectedOrder.total * 0.05)}</Text>
                  </View>
                  <View style={styles.dividerLine} />
                  <View style={styles.receiptSumRow}>
                    <Text style={styles.receiptSumGrand}>Grand Total</Text>
                    <Text style={styles.receiptSumGrandVal}>₹{Math.round(selectedOrder.total * 1.05)}</Text>
                  </View>
                </View>
...
const styles = StyleSheet.create({
  ...
  /* Custom date select input panels */
  customDatePanel: {
