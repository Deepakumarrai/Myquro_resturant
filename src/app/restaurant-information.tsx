...
export default function RestaurantInformationScreen() {
  ...
  const [selectedAddress, setSelectedAddress] = useState(
    params.address || 'Vandi Pathai St, Chennai'
  );
        ...
        >
          ...
          >
            ...
            <View style={styles.card}>
              <View style={styles.cardHeaderRow}>
                <View style={styles.iconBadge}>
                  <Ionicons name="clipboard-outline" size={19} color="#F5A623" />
                </View>
            ...
            <View style={styles.card}>
              <View style={styles.cardHeaderRow}>
                <View style={styles.iconBadge}>
                  <Ionicons name="call" size={18} color="#F5A623" />
                </View>
                  ...
                  {['Monday', 'Tuesday', 'Wednesday', 'Thursday'].map((day) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          {isChecked && (
                            <Ionicons name="checkmark" size={14} color="#F5A623" />
                          )}
                        </View>
...
const styles = StyleSheet.create({
  ...
  checkboxBox: {
    ...
    alignItems: 'center',
    marginRight: 10,
    backgroundColor: 'rgba(11, 14, 22, 0.6)',
  },
  checkboxBoxChecked: {
    borderColor: '#F5A623',
    backgroundColor: 'rgba(245, 166, 35, 0.12)',
