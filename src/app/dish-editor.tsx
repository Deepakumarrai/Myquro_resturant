                    ...
                    return (
                      ...
                      >
                        ...
                        <Text
                          style={[
                            styles.dietaryLabel,
                            isSelected && { color: item.color, fontFamily: 'Urbanist-Bold' },
                          ]}
                        >
                          {item.label}
                        </Text>
              ...
              {imageUri ? (
                ...
                <View style={styles.uploadButtonsRow}>
                  <TouchableOpacity
                    ...
                    activeOpacity={0.75}
                  >
                    <Ionicons name="cloud-upload-outline" size={26} color="#F5A623" />
                  ...
                  <TouchableOpacity
                    ...
                    activeOpacity={0.75}
                  >
                    <Ionicons name="camera-outline" size={26} color="#F5A623" />
              ...
              <View style={styles.sectionHeaderRow}>
                ...
                >
                  <Ionicons
                    ...
                    size={16}
                    color={hasVariants ? '#07090E' : '#F5A623'}
                  />
            ...
            <View style={styles.sectionCard}>
              ...
              {customizationGroups.length === 0 ? (
                <View style={styles.emptyCustomizationBox}>
                  <Ionicons name="extension-puzzle-outline" size={24} color="rgba(255,255,255,0.3)" />
