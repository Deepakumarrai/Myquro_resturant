              ...
              filteredReviews.map((review) => (
                <View key={review.id} style={styles.reviewCard}>
                  ...
                  <View style={styles.orderedItemsContainer}>
                    <Ionicons name="receipt-outline" size={12} color="rgba(255,255,255,0.4)" style={{ marginRight: 6 }} />
                  ...
                  {review.reply ? (
                    <View style={styles.ownerReplyBox}>
                      <View style={styles.replyHeaderRow}>
                        <Ionicons name="chatbubble-ellipses-outline" size={13} color="#F5A623" style={{ marginRight: 6 }} />
                    ...
                    >
                      <Ionicons name="arrow-undo-outline" size={14} color="#F5A623" style={{ marginRight: 6 }} />
